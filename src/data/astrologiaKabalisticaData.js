const ASTROLOGIA_KABALISTICA = Object.freeze([
  Object.freeze({
    ...
    tikunGeneral: 'El Tikun en Aries revela una vida pasada con características de Libra (nodo sur): fuiste árbitro en conflictos pero evitaste tomar decisiones por miedo a herir a alguien. Ahora debes descubrir tu propia identidad, mejorar tu autoestima y dejar de evitar conflictos. Debes aprender a encarar cada situación a medida que se presenta sin la aprobación de los demás. Al combinar la diplomacia de Libra con la valentía de Aries, lograrás la elevación completa de tu alma.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Esta es una de las correcciones más difíciles. Como Escorpio en una vida anterior (nodo sur), fuiste víctima de una injusticia deliberada y desarrollaste desconfianza y una naturaleza autodestructiva. En esta vida, tu Tikun en Tauro te pide superar los temores, la desconfianza y la ira mediante la apertura a las maravillas del mundo. Debes disfrutar la vida sin temor a perder y transformar tu antigua beligerancia en serenidad proactiva.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Sagitario (nodo sur): un niño malcriado guiado solo por deseos egoístas, sin compromiso con causa alguna que no fuera tu propio interés inmediato. Tu Tikun en Géminis te pide comunicarte abiertamente, compartir conocimiento con humildad y respeto por los demás. Debes aprender que la verdadera libertad se forja en las conexiones genuinas, no en la huida constante.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Capricornio (nodo sur), totalmente obsesionada con la victoria profesional y la respetabilidad. Fuiste juez severo que olvidó la piedad, y viviste aislado de los verdaderos placeres de la vida: hogar, familia, amistad. Tu Tikun en Cáncer te pide abandonar la ilusión de que el éxito profesional y la reputación son la clave de la felicidad. Debes encontrar la verdadera satisfacción en la creación de un hogar cálido y amoroso. Tu éxito se encontrará en los ojos amorosos de tu familia.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Acuario (nodo sur) — un individuo que se separó de la multitud. Tenías una enorme fuerza interior y creatividad, pero carecías de disciplina y a menudo no te tomaban en serio. Tenías miedo a estar solo y tolerabas abusos para mantener intimidad. Tu Tikun en Leo te pide abandonar el deseo de originalidad superficial y desarrollar tu capacidad para servir a la humanidad. Debes liderar, pero solo por motivos altruistas.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Piscis (nodo sur) — consumido por sueños y fantasías, con completa falta de discernimiento entre el bien y el mal. Dependías fuertemente de otros y tu intuición te permitía ayudar, pero nunca sin interés propio. Tu Tikun en Virgo te pide adquirir una visión del mundo más realista y menos sensible. Debes usar más la razón, desarrollar autodisciplina y asumir la responsabilidad por ti mismo. Deja el sentimentalismo y actúa.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Aries (nodo sur) — tenías una confianza sorprendente y una gran opinión de ti mismo que te llevó a muchas decepciones. Reaccionabas exageradamente a los fracasos y tenías una visión muy limitada. Tu Tikun en Libra te empuja hacia el camino del sacrificio en su sentido más noble. Debes caminar un sendero de devoción a una causa más allá de ti mismo. Ser parte de un equipo te ayudará a recuperar el equilibrio.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Tauro (nodo sur) — firme, terco, extremadamente reacio al cambio. Un hedonista consumado que perseguía posesiones materiales en lugar de espirituales. Con miedo a perder tu comodidad, te abstuviste de experiencias significativas. Tu Tikun en Escorpio te pide abandonar las estrictas reglas de tu vida anterior y permitir la espontaneidad, confiando en la Luz para tu protección.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Géminis (nodo sur) — vivías en profunda incertidumbre y dualidad. Tomar decisiones era tu mayor obstáculo, y tu inestabilidad perjudicó tu evolución espiritual. Tu Tikun en Sagitario te desafía a definir tus metas y realizarlas, a consolidar tus propias opiniones y comprometerte con la verdad. La integridad será el centro de tu evolución. Tu misión es compartir tu sabiduría y vivir con autenticidad.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Cáncer (nodo sur) — cargabas con ansiedad constante y buscabas seguridad idealizando la vida o aceptando la dirección de otros para evitar responsabilidad. Te negaste a crecer y mantuviste una conducta infantil. Tu Tikun en Capricornio te enseña la madurez. Debes cortar el cordón umbilical con tu familia, aceptar responsabilidades y disfrutar del riesgo calculado. Encuentra una causa digna y fortalécete al servirla.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Leo (nodo sur) — eras el centro de atracción, amabas el lujo y el exhibicionismo. Dominabas a tus subordinados y tu orgullo era tu mayor obstáculo. Tu Tikun en Acuario te causa dificultades en las relaciones para enseñarte a compartir como igual. Debes cambiar tu independencia sagrada por la interdependencia. Silencia tu ego y practica la humildad mientras vives en simplicidad. Tu misión personal es tu misión humanitaria.',
    nisyotPrincipales: [
  ...
  Object.freeze({
    ...
    tikunGeneral: 'Tu vida pasada fue como Virgo (nodo sur) — atrapado en la lógica y las racionalizaciones intrincadas. Tu preocupación por los detalles te hizo irascible y difícil. La rigidez te impidió escuchar y aprender de los demás. Tu Tikun en Piscis te pide entender que la verdad no se percibe solo a través de los sentidos. Debes dejar de analizar el efecto y ver la causa. Una vez que conectes con la realidad espiritual, experimentarás un amor universal que transformará tu percepción de los demás.',
    nisyotPrincipales: [
...
export function getKabbalisticSign(birthdateOrIndex) {
  ...
  if (!birthdateOrIndex || typeof birthdateOrIndex !== 'string') return null;
  const [, month, day] = birthdateOrIndex.split('-').map(Number);
...
export function getTikunSign(birthdate) {
  ...
  const dateNum = parseInt(birthdate.split('-').join(''), 10);
